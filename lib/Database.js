            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 7:
                        _i++;
                        return [3, 5];
                    case 8: return [4, connection.query("UPDATE " + this._entitiesTable + " SET updated_at=NOW() WHERE id=?", [entity.id])];
                    case 9:
                        _c.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        id = _b.sent();
                        return [4, connection.query("INSERT INTO " + this._entitiesTable + " (id) VALUES (?)", [id])];
                    case 5:
                        _b.sent();
